...
@section ('contenido')
<div class="row" >
   @include('pedidos.stock.plus',[$sucursales,$misucursal,$bajo])
 <h4  style="color:rgba(0,0,0,.5); margin-left:1%;">Pedidos/Stock Bajos</h4>
	<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
		<a href=""  data-target="#modal-plus" data-toggle="modal"><button type="button" class="btn btn-info" style="border:none; background:#4CAF50;  "><i class="fa fa-plus"></i><span > Nuevo Pedido</span></button></a>
		<br>
	</div>
...
$('#liPedido').addClass("treeview active");
$('#liStock2').addClass("active");
