...
<ul class="breadcrumb " style="margin-left: 3%; ">
  ...
  <div class="panel panel-default " style="margin-left: 3%; margin-right :3%;" id="rem1">
        ...
        <div class="panel-heading" style="">
          ...
          <h4><span style="color:#9c27b0;">Pedidos</span> Entrantes</h4>
        </div>
                  ...
                  <tr style="color: #888;">
                    ...
                    <td>{{$ped->fecha_hora}}</td>
                          ...
                          @foreach($sucursales as $su)
                            @if($su->idsucursal==$ped->idemisor)
                            <td style="text-align:center;">{{$su->razon}}</td>
                            @endif
                        @endforeach
                         ...
                         <td>{{$ped->nota}}</td>
                         <td> 
                          @include('pedidos.entrantes.show',[$details])
                          <a href=""  data-target="#modal-show-{{$ped->idnotificacion_pedido}}" data-toggle="modal"><button class="btn btn-default btn-xs" style="background:#3C4858; color:#fff; margin-left:30%;"><i class="ti-menu"></i></button></a>
                        </td>
                  </tr>
                @endforeach
              </tbody>
