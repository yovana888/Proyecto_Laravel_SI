...
<ul class="breadcrumb " style="margin-left: 3%; ">
  ...
  <div class="panel panel-default " style="margin-left: 3%; margin-right :3%;" id="rem1">
        ...
        <div class="panel-heading" style="">
            ...
            <h4><span style="color:#9c27b0;">Traslados</span> Realizados</h4>
        </div>
<!-- END panel-heading -->
<!-- BEGIN panel-body -->
          ...
          <table id="datatables-default" class="table  m-1">
				<thead>
					<tr style="text-align:center; " >
						...
						<th style="white-space: nowrap; color:#888;text-align:center;" >Sucursal Destino</th>
               ...
               @foreach ($traslados as $tra)
                <tr>
                    ...
                    @foreach($sucursales as $su)
                        @if($su->idsucursal==$tra->idreceptor)
                    ...
                    <td>   
                    @include('traslados.realizados.show',[$tra->nuevo,$detalles,$tra->idnotificacion_traslado,$tra->estado]) 
        ...
        @include('traslados.realizados.plus',[$misucursal,$sucursales])
         <a href=""  data-target="#modal-plus" data-toggle="modal"><button class="btn btn-pink btn-sm pull-left m-l-5" style="">Nuevo Traslado</button></a>
