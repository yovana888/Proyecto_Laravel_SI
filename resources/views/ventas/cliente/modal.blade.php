		...
		<div class="modal-content" style="border-radius: 15px 15px 15px 15px;">
			<div class="modal-header" style="background:#333; border-radius: 10px 10px 0px 0px;">
				...
				aria-label="Close">
                 ...
                 <h5 class="modal-title" style="color:#fff;"><span class="label label" style="color:#fff; background:#019299; font-size:12px;">Cliente:</span><span style="color:#d9d6d8;"> {{ $per->nombre}}</span></h5>
			</div>
			<div class="modal-body" style="background:#f8f8f8; border-radius: 0px 0px 10px 10px; ">
				<p style=" color:#666; font-size:20px;">Confirme si desea Cambiar el estado del Cliente</p>
			</div>
