...
role="dialog" tabindex="-1" id="modal-edit-{{$mat->idmaterial}}">
		...
		<div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
			<div class="modal-header" style="background:#444; height:70px;">
				...
				aria-label="Close">
                  ...
                  <h3 class="modal-title " style="color:#fff; "><i class="ti-pencil"></i> Editar Material</h3>
			</div>
			<div class="modal-body" style="background:#f8f8f8; ">
                     ...
                     @endif
                     	...
                     	{!!Form::model($mat,['method'=>'PATCH','route'=>['almacen.material.update',$mat->idmaterial]])!!}
                        {{Form::token()}}
                    <div class="form-group">
                        <label for="nombre" style="color:#888;">Nombre</label>
                        <input type="text" name="nombre" class="form-control" value="{{$mat->nombre}}" placeholder="Nombre..." style="color:#777;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idsubcategoria" class="form-control">
                            @foreach ($subcategorias as $sb)
                                @if ($sb->idsubcategoria==$mat->idsubcategoria)
