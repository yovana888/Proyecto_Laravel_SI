...
role="dialog" tabindex="-1" id="modal-edit-{{$cl->idclub}}">
		...
		<div class="modal-content" style="border-radius: 15px 15px 15px 15px;">
			...
			<div class="modal-body" style="background:#f8f8f8; border-radius: 0px 0px 10px 10px; ">
                     ...
                     @endif
                     	...
                     	{!!Form::model($cl,['method'=>'PATCH','route'=>['almacen.club.update',$cl->idclub]])!!}
                        {{Form::token()}}
                    <div class="form-group">
                        <label for="nombre" style="color:#019299;">Nombre</label>
                        <input type="text" name="nombre" class="form-control" value="{{$cl->nombre}}" placeholder="Nombre..." style="color:#777;">
                    </div>
