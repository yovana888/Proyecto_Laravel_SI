...
role="dialog" tabindex="-1" id="modal-delete-{{$tip->idtipo}}">
	{{Form::Open(array('action'=>array('TipoController@destroy',$tip->idtipo),'method'=>'delete'))}}
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
          ...
          <h3 class="modal-title " style="color:#fff; "><i class="ti-alert"></i> Desactivar Modelo</h3>
			</div>
