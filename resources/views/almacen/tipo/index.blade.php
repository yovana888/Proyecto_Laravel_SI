...
<ul class="breadcrumb " style="margin-left: 3%; ">
  ...
  <div class="panel panel-default " style="margin-left: 3%; margin-right :3%;" id="rem1">
        <div class="panel-heading" >
            ...
            <h4><span class="text-purple " >Modelos</span> Registrados</h4>
        </div>
<!-- END panel-heading -->
<!-- BEGIN panel-body -->
        <div class="panel-body">
          ...
          @foreach ($tipos as $tip)
            ...
            <td><span class="label label" style="background:#5cb85c;">{{ $tip->estado}}</span></td>
            @else
            <td><span class="label label" style="background:#8A8A8F;">{{ $tip->estado}}</span></td>
            @endif

						<td class="btn-col" style="white-space: nowrap">
              <a href=""  data-target="#modal-edit-{{$tip->idtipo}}" data-toggle="modal"><button class="btn btn btn-xs" style="background:#00bcd4; color:#fff;font-weight: bold;"><i class="ti-pencil"></i></button></a>

              <a href="" data-target="#modal-delete-{{$tip->idtipo}}" data-toggle="modal" ><button class="btn btn-pink btn-xs" style="background:; color:#fff;font-weight: bold;"
...
<!-- END panel-body -->
        ...
        <div class="panel-footer clearfix">
                 ...
                 <a href=""  data-target="#modal-create" data-toggle="modal"><button class="btn btn-pink btn-sm pull-left m-l-5" >Nuevo Modelo</button></a>
