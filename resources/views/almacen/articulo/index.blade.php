...
<!-- BEGIN panel-body -->
        <div class="panel-body">
          ...
          @foreach ($articulos as $art)
            ...
            <td style="text-align : center;"><span class="label label" style="background:#5cb85c;">{{ $art->estado}}</span></td>
            @else
            <td style="text-align : center;"><span class="label label" style="background:#8A8A8F;">{{ $art->estado}}</span></td>
            @endif
            ...
            <td style="text-align : justify;display:none;">{{ $art->tipo}}</td>
              ...
              <a  href="{{URL::action('ArticuloController@show',$art->idarticulo)}}" ><button class="btn btn btn-xs" style="background:#00bcd4; color:#fff;font-weight: bold;"><i class="ti-menu"></i></button></a>
              <a href=""  data-target="#" data-toggle="modal"><button class="btn btn btn-xs" style="background:#ff5160; color:#fff;"><i class="ti-pencil"></i></button></a>
...
<!-- END panel-body -->
        ...
        <div class="panel-footer clearfix">
								@include('almacen.articulo.create',$categorias)
                 <a href=""  data-target="#modal-create" data-toggle="modal"><button class="btn btn-pink btn-sm pull-left m-l-5" >Nuevo Articulo</button></a>
