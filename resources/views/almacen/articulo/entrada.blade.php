...
<div class="modal fade" id="modal-entrada-{{$art->idarticulo}}" role="dialog">
      ...
      <div class="modal-content" style="border-radius: 15px 15px 15px 15px;">
        ...
        <div class="modal-body" style="background:#f8f8f8; border-radius: 0px 0px 10px 10px; ">
          ...
          <div class="form-group wr">
                ...
                {{Form::token()}}
             <h5 class=""><span class="label label" style="color:#fff; font-size:12px; background:#5cb85c;">Nueva Entrada</span></h5>
                   ...
                   <div class="row">
                    ...
                    <input id="idarticulo" type="text"  style="display:none;" name="idarticulo" value="{{$art->idarticulo}}">
                     ...
                     <input id="tipo_movimiento" type="text"  style="display:none;" name="tipo_movimiento" value="Entrada">
                     
                     <input id="stock" type="text"  style="display:none;" name="stock" value="{{$art->stock}}">
                    
                      <input id="ds" type="text"  style="display:none;" name="ds" value="Almacen">
        ...
        <a href="" ><button type="submit" class="btn btn-danger" style=" background:#019299; border:none;" >Ingresar</button></a>
