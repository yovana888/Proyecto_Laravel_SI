...
role="dialog" tabindex="-1" id="modal-delete-{{$ed->idedad}}">
	{{Form::Open(array('action'=>array('EdadController@destroy',$ed->idedad),'method'=>'delete'))}}
		...
		<div class="modal-content" style="border-radius: 0px 0px 0px 0px;">
			<div class="modal-header"  style="background:#444; height:70px;">
				...
				aria-label="Close">
                  ...
                  <h3 class="modal-title " style="color:#fff; "><i class="ti-alert"></i> Desactivar Unidad</h3>
			</div>
			<div class="modal-body" style="background:#f8f8f8; ">
				<h4 class="text-muted">Confirme si desea Desactivar la Unidad</h4>
			</div>
